...
// API Endpoints
#define IP_GEO_API          "http://ip-api.com/json/?fields=status,message,country,regionName,city,lat,lon,timezone,offset,query"
#define YAHOO_FINANCE_URL   "https://query1.finance.yahoo.com/v8/finance/chart/NVDA?interval=1d"
